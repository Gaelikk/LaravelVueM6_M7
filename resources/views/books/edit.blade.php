...
@section('content')
    ...
    <div class="container d-flex justify-content-center mt-5">
        <div class="col-5 bg-light border rounded">
            <div class="row p-3">
                <h2 class="text-center my-2">Edita Reserva</h2>
                <form method="POST" action="{{url("/books/update/$book->id")}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="phone" class="form-control @error('phone') is-invalid @enderror" name="phone"
                               type="text" maxlength="9" value="{{ $book->phone }}">
                        @error('phone')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control mb-3" id="country" name="country" value="{{ $book->country }}"
                                    type="text">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            Sala: <select name="room" class="form-select">
                        ...
                        <div class="col-md-6">
                            Joc: <select name="game" class="form-select">
